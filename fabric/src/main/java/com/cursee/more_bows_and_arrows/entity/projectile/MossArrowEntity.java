...
public class MossArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public MossArrowEntity(EntityType<? extends MossArrowEntity> entType, Level level, ItemStack itemStack) {
        super(entType, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public MossArrowEntity(Level level, LivingEntity liveEntity, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.MOSS_ARROW_ENTITY, liveEntity, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    ...
    public MossArrowEntity(Level level, double x, double y, double z, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.MOSS_ARROW_ENTITY, x, y, z, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public MossArrowEntity(Level level, LivingEntity liveEntity) {
        this(level, liveEntity, new ItemStack(FabricItemRegistry.MOSS_ARROW_ITEM));
    }
    
    public MossArrowEntity(EntityType<MossArrowEntity> MossArrowEntityEntityType, Level level) {
        this(MossArrowEntityEntityType, level, new ItemStack(FabricItemRegistry.MOSS_ARROW_ITEM));
    }
