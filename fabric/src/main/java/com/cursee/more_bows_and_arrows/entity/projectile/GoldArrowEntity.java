...
public class GoldArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public GoldArrowEntity(double d, double e, double f, Level level, ItemStack itemStack, @Nullable ItemStack itemStack2) {
        super(FabricEntityTypeRegistry.GOLD_ARROW_ENTITY, d, e, f, level, itemStack, itemStack2);
    ...
    public GoldArrowEntity(Level level, LivingEntity livingEntity, ItemStack itemStack, ItemStack itemStack2) {
        super(FabricEntityTypeRegistry.GOLD_ARROW_ENTITY, livingEntity, level, itemStack, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0d);
    }
