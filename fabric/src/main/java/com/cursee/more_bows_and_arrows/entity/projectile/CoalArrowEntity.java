...
public class CoalArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public CoalArrowEntity(EntityType<? extends CoalArrowEntity> entType, Level level, ItemStack itemStack) {
        super(entType, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public CoalArrowEntity(Level level, LivingEntity liveEntity, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.COAL_ARROW_ENTITY, liveEntity, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    ...
    public CoalArrowEntity(Level level, double x, double y, double z, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.COAL_ARROW_ENTITY, x, y, z, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public CoalArrowEntity(Level level, LivingEntity liveEntity) {
        this(level, liveEntity, new ItemStack(FabricItemRegistry.COAL_ARROW_ITEM));
    }
    
    public CoalArrowEntity(EntityType<CoalArrowEntity> CoalArrowEntityEntityType, Level level) {
        this(CoalArrowEntityEntityType, level, new ItemStack(FabricItemRegistry.COAL_ARROW_ITEM));
    }
