...
public class BoneArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public BoneArrowEntity(EntityType<? extends BoneArrowEntity> entType, Level level, ItemStack itemStack) {
        super(entType, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public BoneArrowEntity(Level level, LivingEntity liveEntity, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.BONE_ARROW_ENTITY, liveEntity, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    ...
    public BoneArrowEntity(Level level, double x, double y, double z, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.BONE_ARROW_ENTITY, x, y, z, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public BoneArrowEntity(Level level, LivingEntity liveEntity) {
        this(level, liveEntity, new ItemStack(FabricItemRegistry.BONE_ARROW_ITEM));
    }
    
    public BoneArrowEntity(EntityType<BoneArrowEntity> BoneArrowEntityEntityType, Level level) {
        this(BoneArrowEntityEntityType, level, new ItemStack(FabricItemRegistry.BONE_ARROW_ITEM));
    }
