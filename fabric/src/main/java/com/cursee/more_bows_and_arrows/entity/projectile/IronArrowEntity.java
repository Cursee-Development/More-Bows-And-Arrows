...
public class IronArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public IronArrowEntity(EntityType<? extends IronArrowEntity> entType, Level level, ItemStack itemStack) {
        super(entType, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public IronArrowEntity(Level level, LivingEntity liveEntity, ItemStack itemStack) {
    ...
    public IronArrowEntity(Level level, double x, double y, double z, ItemStack itemStack) {
        super(FabricEntityTypeRegistry.DIAMOND_ARROW_ENTITY, x, y, z, level, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0);
    }
    
    public IronArrowEntity(Level level, LivingEntity liveEntity) {
        this(level, liveEntity, new ItemStack(FabricItemRegistry.DIAMOND_ARROW_ITEM));
    }
    
    public IronArrowEntity(EntityType<IronArrowEntity> IronArrowEntityEntityType, Level level) {
        this(IronArrowEntityEntityType, level, new ItemStack(FabricItemRegistry.DIAMOND_ARROW_ITEM));
    }
    ...
    protected @NotNull ItemStack getDefaultPickupItem() {
        return new ItemStack(FabricItemRegistry.IRON_ARROW_ITEM);
    }
}
