...
public class MultiArrowItem extends ArrowItem {
    ...
    @Override
    public AbstractArrow createArrow(Level level, ItemStack itemStack, LivingEntity entity, @Nullable ItemStack itemStack2) {
        AbstractArrow toReturn;
        switch (this.type) {
            case AMETHYST -> toReturn = new AmethystArrow(entity, level);
            ...
            default -> toReturn = new Arrow(level, entity, Items.ARROW.getDefaultInstance(), null);
        }
        return toReturn;
    }
