...
public class DiamondArrow extends AbstractArrow implements ICustomArrow {
    ...
    public DiamondArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.DIAMOND_ARROW, entity, level, new ItemStack(ModItemsFabric.DIAMOND_ARROW), new ItemStack(ModItemsFabric.DIAMOND_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public DiamondArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.DIAMOND_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.DIAMOND_ARROW), new ItemStack(ModItemsFabric.DIAMOND_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsFabric.DIAMOND_ARROW);
    }
