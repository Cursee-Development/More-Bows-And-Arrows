...
public class FlintAndSteelArrow extends AbstractArrow implements ICustomArrow {
    ...
    public FlintAndSteelArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.FLINT_AND_STEEL_ARROW, entity, level, new ItemStack(ModItemsFabric.FLINT_AND_STEEL_ARROW), new ItemStack(ModItemsFabric.FLINT_AND_STEEL_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public FlintAndSteelArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.FLINT_AND_STEEL_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.FLINT_AND_STEEL_ARROW), new ItemStack(ModItemsFabric.FLINT_AND_STEEL_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
