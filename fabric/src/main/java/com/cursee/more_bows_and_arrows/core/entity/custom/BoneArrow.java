...
public class BoneArrow extends AbstractArrow implements ICustomArrow {
    ...
    public BoneArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.BONE_ARROW, entity, level, new ItemStack(ModItemsFabric.BONE_ARROW), new ItemStack(ModItemsFabric.BONE_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public BoneArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.BONE_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.BONE_ARROW), new ItemStack(ModItemsFabric.BONE_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
