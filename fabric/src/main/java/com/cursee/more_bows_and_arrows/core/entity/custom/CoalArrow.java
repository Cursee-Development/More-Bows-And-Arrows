...
public class CoalArrow extends AbstractArrow implements ICustomArrow {
    ...
    public CoalArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.COAL_ARROW, entity, level, new ItemStack(ModItemsFabric.COAL_ARROW), new ItemStack(ModItemsFabric.COAL_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public CoalArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.COAL_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.COAL_ARROW), new ItemStack(ModItemsFabric.COAL_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
