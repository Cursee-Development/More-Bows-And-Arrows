...
public class ModEntitiesFabric {
    ...
    public static final EntityType<AmethystArrow> AMETHYST_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "amethyst_arrow"),
    ...
    public static final EntityType<BambooArrow> BAMBOO_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "bamboo_arrow"),
    ...
    public static final EntityType<BlazeRodArrow> BLAZE_ROD_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "blaze_arrow"),
    ...
    public static final EntityType<BoneArrow> BONE_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "bone_arrow"),
    ...
    public static final EntityType<CactusArrow> CACTUS_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "cactus_arrow"),
    ...
    public static final EntityType<CoalArrow> COAL_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "coal_arrow"),
    ...
    public static final EntityType<CopperArrow> COPPER_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "copper_arrow"),
    ...
    public static final EntityType<DiamondArrow> DIAMOND_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "diamond_arrow"),
    ...
    public static final EntityType<EmeraldArrow> EMERALD_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "emerald_arrow"),
    ...
    public static final EntityType<EnderPearlArrow> ENDER_PEARL_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "ender_pearl_arrow"),
    ...
    public static final EntityType<FlintAndSteelArrow> FLINT_AND_STEEL_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "flint_and_steel_arrow"),
    ...
    public static final EntityType<FlintArrow> FLINT_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "flint_arrow"),
    ...
    public static final EntityType<GoldArrow> GOLD_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "gold_arrow"),
    ...
    public static final EntityType<IronArrow> IRON_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "iron_arrow"),
    ...
    public static final EntityType<LapisArrow> LAPIS_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "lapis_arrow"),
    ...
    public static final EntityType<MossArrow> MOSS_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "moss_arrow"),
    ...
    public static final EntityType<NetheriteArrow> NETHERITE_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "netherite_arrow"),
    ...
    public static final EntityType<ObsidianArrow> OBSIDIAN_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "obsidian_arrow"),
    ...
    public static final EntityType<PaperArrow> PAPER_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "paper_arrow"),
    ...
    public static final EntityType<TNTArrow> TNT_ARROW = Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "tnt_arrow"),
...
//        return Registry.register(BuiltInRegistries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, name), entityType);
//    }
