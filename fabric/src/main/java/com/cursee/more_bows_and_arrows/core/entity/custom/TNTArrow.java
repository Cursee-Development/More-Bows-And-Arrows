...
public class TNTArrow extends AbstractArrow implements ICustomArrow {
    ...
    public TNTArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.TNT_ARROW, entity, level, new ItemStack(ModItemsFabric.TNT_ARROW), new ItemStack(ModItemsFabric.TNT_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public TNTArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.TNT_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.TNT_ARROW), new ItemStack(ModItemsFabric.TNT_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
