...
public class BlazeRodArrow extends AbstractArrow implements ICustomArrow {
    ...
    public BlazeRodArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.BLAZE_ROD_ARROW, entity, level, new ItemStack(ModItemsFabric.BLAZE_ROD_ARROW), new ItemStack(ModItemsFabric.BLAZE_ROD_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public BlazeRodArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.BLAZE_ROD_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.BLAZE_ROD_ARROW), new ItemStack(ModItemsFabric.BLAZE_ROD_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
