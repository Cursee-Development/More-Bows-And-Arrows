...
public class FlintArrow extends AbstractArrow implements ICustomArrow {
    ...
    public FlintArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.FLINT_ARROW, entity, level, new ItemStack(ModItemsFabric.FLINT_ARROW), new ItemStack(ModItemsFabric.FLINT_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public FlintArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.FLINT_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.FLINT_ARROW), new ItemStack(ModItemsFabric.FLINT_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsFabric.FLINT_ARROW);
    }
