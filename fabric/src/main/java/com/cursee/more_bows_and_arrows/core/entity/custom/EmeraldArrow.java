...
public class EmeraldArrow extends AbstractArrow implements ICustomArrow {
    ...
    public EmeraldArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.EMERALD_ARROW, entity, level, new ItemStack(ModItemsFabric.EMERALD_ARROW), new ItemStack(ModItemsFabric.EMERALD_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public EmeraldArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.EMERALD_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.EMERALD_ARROW), new ItemStack(ModItemsFabric.EMERALD_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsFabric.EMERALD_ARROW);
    }
