...
public class LapisArrow extends AbstractArrow implements ICustomArrow {
    ...
    public LapisArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.LAPIS_ARROW, entity, level, new ItemStack(ModItemsFabric.LAPIS_ARROW), new ItemStack(ModItemsFabric.LAPIS_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public LapisArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.LAPIS_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.LAPIS_ARROW), new ItemStack(ModItemsFabric.LAPIS_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsFabric.LAPIS_ARROW);
    }
