...
public class NetheriteArrow extends AbstractArrow implements ICustomArrow {
    ...
    public NetheriteArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesFabric.NETHERITE_ARROW, entity, level, new ItemStack(ModItemsFabric.NETHERITE_ARROW), new ItemStack(ModItemsFabric.NETHERITE_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public NetheriteArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesFabric.NETHERITE_ARROW, x, y, z, level, new ItemStack(ModItemsFabric.NETHERITE_ARROW), new ItemStack(ModItemsFabric.NETHERITE_ARROW));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsFabric.NETHERITE_ARROW);
    }
