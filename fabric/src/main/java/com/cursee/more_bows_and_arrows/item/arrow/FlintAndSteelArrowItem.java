...
public class FlintAndSteelArrowItem extends ArrowItem {
    ...
    public @NotNull AbstractArrow createArrow(@NotNull Level level, @NotNull ItemStack arrowItem, @NotNull LivingEntity livingEntity) {
        return new FlintAndSteelArrowEntity(level, livingEntity, arrowItem);
    }

    public Projectile asProjectile(Level p_331476_, Position p_329787_, ItemStack p_328274_, Direction p_330256_) {
        FlintAndSteelArrowEntity $$4 = new FlintAndSteelArrowEntity(p_331476_, p_329787_.x(), p_329787_.y(), p_329787_.z(), p_328274_.copyWithCount(1));
