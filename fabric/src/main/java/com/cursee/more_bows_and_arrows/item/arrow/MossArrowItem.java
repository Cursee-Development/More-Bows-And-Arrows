...
public class MossArrowItem extends ArrowItem {
    ...
    public void appendHoverText(ItemStack itemStack, TooltipContext tooltipContext, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        tooltip.add(Component.translatable("morebowsandarrows.text.moss_arrow_damage"));
    }
    ...
    public @NotNull AbstractArrow createArrow(@NotNull Level level, @NotNull ItemStack arrowItem, @NotNull LivingEntity livingEntity) {
        return new MossArrowEntity(level, livingEntity, arrowItem);
    }

    public Projectile asProjectile(Level p_331476_, Position p_329787_, ItemStack p_328274_, Direction p_330256_) {
        MossArrowEntity $$4 = new MossArrowEntity(p_331476_, p_329787_.x(), p_329787_.y(), p_329787_.z(), p_328274_.copyWithCount(1));
