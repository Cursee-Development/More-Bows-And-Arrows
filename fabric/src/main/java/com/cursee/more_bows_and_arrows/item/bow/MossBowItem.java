...
public class MossBowItem extends BowItem {
    ...
    public MossBowItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack itemStack, TooltipContext tooltipContext, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        tooltip.add(Component.translatable("morebowsandarrows.text.moss_bow_lore"));
        tooltip.add(Component.translatable("morebowsandarrows.text.moss_bow_damage"));
    }
