...
public class BlazeRodArrowItem extends ArrowItem {
    ...
    public AbstractArrow createArrow(Level level, ItemStack itemStack, LivingEntity livingEntity, @Nullable ItemStack itemStack2) {
        return new BlazeRodArrowEntity(level, livingEntity, itemStack.copyWithCount(1), itemStack2);
    }

    public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
//    AmethystArrowEntity $$4 = new AmethystArrowEntity(level, pos.x(), pos.y(), pos.z(), stack.copyWithCount(1));
        BlazeRodArrowEntity $$4 = new BlazeRodArrowEntity(pos.x(), pos.y(), pos.z(), level, stack.copyWithCount(1), null);
