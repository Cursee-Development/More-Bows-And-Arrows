...
public class FlintAndSteelArrow extends AbstractArrow implements ICustomArrow {
    ...
    public FlintAndSteelArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.FLINT_AND_STEEL_ARROW.get(), entity, level, new ItemStack(ModItemsForge.FLINT_AND_STEEL_ARROW.get()), new ItemStack(ModItemsForge.FLINT_AND_STEEL_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public FlintAndSteelArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.FLINT_AND_STEEL_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.FLINT_AND_STEEL_ARROW.get()), new ItemStack(ModItemsForge.FLINT_AND_STEEL_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsForge.FLINT_AND_STEEL_ARROW.get());
    }
