...
public class BlazeRodArrow extends AbstractArrow implements ICustomArrow {
    ...
    public BlazeRodArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.BLAZE_ROD_ARROW.get(), entity, level, new ItemStack(ModItemsForge.BLAZE_ROD_ARROW.get()), new ItemStack(ModItemsForge.BLAZE_ROD_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public BlazeRodArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.BLAZE_ROD_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.BLAZE_ROD_ARROW.get()), new ItemStack(ModItemsForge.BLAZE_ROD_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsForge.BLAZE_ROD_ARROW.get());
    }
