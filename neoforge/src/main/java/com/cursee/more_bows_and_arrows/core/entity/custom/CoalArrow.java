...
public class CoalArrow extends AbstractArrow implements ICustomArrow {
    ...
    public CoalArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.COAL_ARROW.get(), entity, level, new ItemStack(ModItemsForge.COAL_ARROW.get()), new ItemStack(ModItemsForge.COAL_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public CoalArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.COAL_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.COAL_ARROW.get()), new ItemStack(ModItemsForge.COAL_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
