...
public class IronArrow extends AbstractArrow implements ICustomArrow {
    ...
    public IronArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.IRON_ARROW.get(), entity, level, new ItemStack(ModItemsForge.IRON_ARROW.get()), new ItemStack(ModItemsForge.IRON_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public IronArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.IRON_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.IRON_ARROW.get()), new ItemStack(ModItemsForge.IRON_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsForge.IRON_ARROW.get());
    }
