...
public class MossArrow extends AbstractArrow implements ICustomArrow {
    ...
    public MossArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.MOSS_ARROW.get(), entity, level, new ItemStack(ModItemsForge.MOSS_ARROW.get()), new ItemStack(ModItemsForge.MOSS_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public MossArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.MOSS_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.MOSS_ARROW.get()), new ItemStack(ModItemsForge.MOSS_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
