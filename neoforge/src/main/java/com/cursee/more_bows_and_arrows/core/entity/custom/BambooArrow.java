...
public class BambooArrow extends AbstractArrow implements ICustomArrow {
    ...
    public BambooArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.BAMBOO_ARROW.get(), entity, level, ModItemsForge.BAMBOO_ARROW.get().getDefaultInstance(), ModItemsForge.BAMBOO_ARROW.get().getDefaultInstance());
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public BambooArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.BAMBOO_ARROW.get(), x, y, z, level,ModItemsForge.BAMBOO_ARROW.get().getDefaultInstance(), ModItemsForge.BAMBOO_ARROW.get().getDefaultInstance());
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
