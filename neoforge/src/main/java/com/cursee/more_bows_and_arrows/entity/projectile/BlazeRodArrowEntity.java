...
public class BlazeRodArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public BlazeRodArrowEntity(double d, double e, double f, Level level, ItemStack itemStack, @Nullable ItemStack itemStack2) {
        super(ForgeEntityTypeRegistry.BLAZE_ROD_ARROW_ENTITY.get(), d, e, f, level, itemStack, itemStack2);
    ...
    public BlazeRodArrowEntity(Level level, LivingEntity livingEntity, ItemStack itemStack, ItemStack itemStack2) {
        super(ForgeEntityTypeRegistry.BLAZE_ROD_ARROW_ENTITY.get(), livingEntity, level, itemStack, itemStack);
        this.setBaseDamage(this.getBaseDamage() + 4.0d);
    }
