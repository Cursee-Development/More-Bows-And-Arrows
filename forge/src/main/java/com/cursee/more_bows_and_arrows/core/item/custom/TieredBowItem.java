    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        ...
        switch (itemStack.getDisplayName().getString()) {
            ...
            case "[Crimson Stem Bow]", "[Stripped Crimson Stem Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.crimson_stem_bow_lore"));
            ...
            case "[Warped Stem Bow]", "[Stripped Warped Stem Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.warped_stem_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.warped_stem_bow_damage"));
            }

            case "[Paper Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.paper_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.paper_bow_damage"));
            }
            case "[Moss Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.moss_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.moss_bow_damage"));
            }
            case "[Lapis Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.lapis_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.lapis_bow_damage"));
            }
            case "[Amethyst Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.amethyst_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.amethyst_bow_damage"));
            }
            case "[Bone Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.bone_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.bone_bow_damage"));
            }
            case "[Coal Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.coal_bow_lore"));
            ...
            case "[Blaze Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.blaze_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.blaze_bow_damage"));
            }
            case "[Obsidian Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.obsidian_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.obsidian_bow_damage"));
            }
            case "[Iron Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.iron_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.iron_bow_damage"));
            }
            case "[Copper Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.copper_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.copper_bow_damage"));
            }
            case "[Gold Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.gold_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.gold_bow_damage"));
            }
            case "[Diamond Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.diamond_bow_lore"));
                list.add(Component.translatable("more_bows_and_arrows.text.diamond_bow_damage"));
            }
            case "[Netherite Bow]" -> {
                list.add(Component.translatable("more_bows_and_arrows.text.netherite_bow_lore"));
