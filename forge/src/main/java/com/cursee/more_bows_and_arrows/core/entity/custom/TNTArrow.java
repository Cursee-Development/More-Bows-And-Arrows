...
public class TNTArrow extends AbstractArrow implements ICustomArrow {
    ...
    public TNTArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.TNT_ARROW.get(), entity, level, new ItemStack(ModItemsForge.TNT_ARROW.get()), new ItemStack(ModItemsForge.TNT_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public TNTArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.TNT_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.TNT_ARROW.get()), new ItemStack(ModItemsForge.TNT_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
    ...
    protected void onHit(HitResult result) {
        ...
        if (result.getType() == HitResult.Type.BLOCK || result.getType() == HitResult.Type.ENTITY) this.discard();
        super.onHit(result);
    }
}
