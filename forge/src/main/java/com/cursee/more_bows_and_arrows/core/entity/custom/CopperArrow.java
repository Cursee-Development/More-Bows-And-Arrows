...
public class CopperArrow extends AbstractArrow implements ICustomArrow {
    ...
    public CopperArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.COPPER_ARROW.get(), entity, level, new ItemStack(ModItemsForge.COPPER_ARROW.get()), new ItemStack(ModItemsForge.COPPER_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public CopperArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.COPPER_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.COPPER_ARROW.get()), new ItemStack(ModItemsForge.COPPER_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
