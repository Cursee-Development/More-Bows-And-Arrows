...
public class BoneArrow extends AbstractArrow implements ICustomArrow {
    ...
    public BoneArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.BONE_ARROW.get(), entity, level, new ItemStack(ModItemsForge.BONE_ARROW.get()), new ItemStack(ModItemsForge.BONE_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public BoneArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.BONE_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.BONE_ARROW.get()), new ItemStack(ModItemsForge.BONE_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItemsForge.BONE_ARROW.get());
    }
