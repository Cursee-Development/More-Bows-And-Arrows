...
public class ObsidianArrow extends AbstractArrow implements ICustomArrow {
    ...
    public ObsidianArrow(Level level, LivingEntity entity) {
        super((EntityType) ModEntitiesForge.OBSIDIAN_ARROW.get(), entity, level, new ItemStack(ModItemsForge.OBSIDIAN_ARROW.get()), new ItemStack(ModItemsForge.OBSIDIAN_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
        this.setOwner(entity);
    }

    public ObsidianArrow(Level level, double x, double y, double z) {
        super((EntityType) ModEntitiesForge.OBSIDIAN_ARROW.get(), x, y, z, level, new ItemStack(ModItemsForge.OBSIDIAN_ARROW.get()), new ItemStack(ModItemsForge.OBSIDIAN_ARROW.get()));
        this.setBaseDamage(this.getBaseDamage() + 2.0d);
    }
